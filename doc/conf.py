# -*- coding: utf-8 -*-
#
# kiskadee documentation build configuration file, created by
...
with open(kiskadeefile) as stream:
    ...
    VERSION = regex.match(stream.read()).group(1)
...
latex_documents = [
    (master_doc, 'kiskadee.tex', u'kiskadee Documentation',
     u'Athos Ribeiro, David Silva', 'manual'),
]
...
man_pages = [
    (master_doc, 'kiskadee', u'kiskadee Documentation',
     [author], 1)
]
